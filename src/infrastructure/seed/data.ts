...
export const products: Product[] = [
  { id: 'prod-1', orgId: ORG, name: 'K-Othrine SC 25', categoryId: 'cat-ins', manufacturer: 'Bayer', supplierId: 'sup-1', registrationCode: 'MS 3.0294.0001', activeIngredient: 'Deltametrina', chemicalGroup: 'Piretróide', antidote: 'Sintomático', applicationType: 'Pulverização', dosage: '20ml/L', unit: 'L', minQuantity: 5, price: 189.9, isRegulated: true, isActive: true, storageLocation: 'A1', batches: [{ id: 'b-1a', code: 'KO-2408', expiresAt: daysFromNow(52), quantity: 10, receivedAt: daysFromNow(-20) }, { id: 'b-1b', code: 'KO-2312', expiresAt: daysFromNow(140), quantity: 6, receivedAt: daysFromNow(-70) }] },
  { id: 'prod-2', orgId: ORG, name: 'Klerat Blocos', categoryId: 'cat-rod', manufacturer: 'Syngenta', supplierId: 'sup-1', registrationCode: 'MS 2.0154.0002', activeIngredient: 'Brodifacoum', chemicalGroup: 'Hidroxicumarina', antidote: 'Vitamina K1 e tratamento sintomático', applicationType: 'Isca', dosage: '1 bloco/PEA', unit: 'kg', minQuantity: 3, price: 96.5, isRegulated: true, isActive: true, storageLocation: 'B2', batches: [{ id: 'b-2a', code: 'KL-2401', expiresAt: daysFromNow(9), quantity: 2, receivedAt: daysFromNow(-90) }] },
  { id: 'prod-3', orgId: ORG, name: 'Fipronil Gel Barata', categoryId: 'cat-ins', manufacturer: 'BASF', supplierId: 'sup-2', registrationCode: 'MS 3.1055.0007', activeIngredient: 'Fipronil', chemicalGroup: 'Fenilpirazol', antidote: 'Sintomático', applicationType: 'Gel', dosage: 'pontos de 0,5g', unit: 'un', minQuantity: 10, price: 74.0, isRegulated: true, isActive: true, storageLocation: 'A3', batches: [{ id: 'b-3a', code: 'FG-2405', expiresAt: daysFromNow(18), quantity: 6, receivedAt: daysFromNow(-30) }, { id: 'b-3b', code: 'FG-2502', expiresAt: daysFromNow(150), quantity: 18, receivedAt: daysFromNow(-5) }] },
  { id: 'prod-4', orgId: ORG, name: 'Premise 200 SC', categoryId: 'cat-cup', manufacturer: 'Bayer', supplierId: 'sup-1', registrationCode: 'MS 3.0294.0033', activeIngredient: 'Imidacloprido', chemicalGroup: 'Neonicotinóide', antidote: 'Sintomático', applicationType: 'Injeção', dosage: '10ml/L', unit: 'L', minQuantity: 4, price: 264.0, isRegulated: true, isActive: true, storageLocation: 'C1' },
  { id: 'prod-5', orgId: ORG, name: 'Quaternário de Amônio 5ª', categoryId: 'cat-san', manufacturer: 'Start Química', supplierId: 'sup-2', activeIngredient: 'Cloreto de benzalcônio', chemicalGroup: 'Amônio Quaternário', antidote: 'Não há', applicationType: 'Atomização', dosage: '10ml/L', unit: 'L', minQuantity: 8, price: 58.0, isRegulated: false, isActive: true, storageLocation: 'D2', batches: [{ id: 'b-5a', code: 'QA-2312', expiresAt: daysFromNow(-4), quantity: 4, receivedAt: daysFromNow(-200) }, { id: 'b-5b', code: 'QA-2504', expiresAt: daysFromNow(200), quantity: 30, receivedAt: daysFromNow(-10) }] },
  ...
  // ── Catálogo real da empresa (planilha de produtos) ──────────────────
  // Importados da planilha PRODUTO/GRUPO QUIMICO/PRINCIPIO ATIVO/DILUENTE/
  // REGISTRO MS/ANTIDOTO/TRATAMENTO. Preço e unidade ficam a definir no
  // cadastro — a planilha não traz essa informação.
  { id: 'prod-tenopa', orgId: ORG, name: 'Tenopa', categoryId: 'cat-ins', registrationCode: '3.0404.035.001-2', activeIngredient: 'Alfa-Cipermetrina e Flufenoxurom', chemicalGroup: 'Piretroide e Benzoilureia', diluent: 'Água', reportLabel: 'principio_ativo', unit: 'un', minQuantity: 0, price: 0, isRegulated: true, isActive: true },
  { id: 'prod-maxforce', orgId: ORG, name: 'Maxforce', categoryId: 'cat-ins', registrationCode: '3.3222.0040', activeIngredient: 'Imidacloprido 2,15%p/p', chemicalGroup: 'Neonicotinóide', diluent: 'Gel', reportLabel: 'principio_ativo', unit: 'un', minQuantity: 0, price: 0, isRegulated: true, isActive: true },
  { id: 'prod-fomifim', orgId: ORG, name: 'Fomifim', categoryId: 'cat-cup', registrationCode: '3.2398.0002.001-9', activeIngredient: 'Imidacloprido 0,015% + Fipronil 0,015%', chemicalGroup: 'Neonicotinóide', diluent: 'Pronto para Uso', reportLabel: 'principio_ativo', unit: 'un', minQuantity: 0, price: 0, isRegulated: true, isActive: true },
  { id: 'prod-aerotec', orgId: ORG, name: 'Aerotec', categoryId: 'cat-ins', registrationCode: '3.0425.0105.001-0', activeIngredient: 'Praletrina 0,10%p/p, Delfametrina 0,02%p/p, Butóxido de Piperonila', chemicalGroup: 'Peritróide e Peritrinas', diluent: 'Pronto para Uso', reportLabel: 'principio_ativo', unit: 'un', minQuantity: 0, price: 0, isRegulated: true, isActive: true },
  { id: 'prod-ratol-granulado', orgId: ORG, name: 'Ratol Granulado', categoryId: 'cat-rod', registrationCode: '3.2398.0019.002-1', activeIngredient: 'Brodifacoum A 0.005%', chemicalGroup: 'Hidroxicumarina', diluent: 'Pronto para Uso', reportLabel: 'principio_ativo', unit: 'un', minQuantity: 0, price: 0, isRegulated: true, isActive: true },
  { id: 'prod-ratol-po-750', orgId: ORG, name: 'Ratol Pó 750', categoryId: 'cat-rod', registrationCode: '323980005', activeIngredient: 'Cumatetralil', chemicalGroup: 'Hidroxicumarina', diluent: 'Pronto para Uso', reportLabel: 'principio_ativo', unit: 'un', minQuantity: 0, price: 0, isRegulated: true, isActive: true },
  { id: 'prod-bloco-parafinado', orgId: ORG, name: 'Bloco Parafinado', categoryId: 'cat-rod', registrationCode: '3.2398.0006.001-0', activeIngredient: 'Brodifacoum 0,005%', chemicalGroup: 'Cumarínico', diluent: 'Pronto para Uso', reportLabel: 'principio_ativo', unit: 'un', minQuantity: 0, price: 0, isRegulated: true, isActive: true },
  { id: 'prod-delfametrina-po', orgId: ORG, name: 'Delfametrina Pó', categoryId: 'cat-ins', registrationCode: '3.2781.0003', activeIngredient: 'Deltametrina', chemicalGroup: 'Peritróide', diluent: 'Pronto para Uso', treatment: 'Formiga, Cupim', reportLabel: 'principio_ativo', unit: 'un', minQuantity: 0, price: 0, isRegulated: true, isActive: true },
  { id: 'prod-termitox', orgId: ORG, name: 'Termitox', categoryId: 'cat-cup', registrationCode: '3328200040011', activeIngredient: 'Fipronil,e azadiractina', chemicalGroup: 'Tetranortriterprnóide', diluent: 'Água', treatment: 'Cupim, Formiga', reportLabel: 'principio_ativo', unit: 'un', minQuantity: 0, price: 0, isRegulated: true, isActive: true },
  { id: 'prod-termimidor-25-ce', orgId: ORG, name: 'Termimidor 25 CE', categoryId: 'cat-cup', registrationCode: '3.0404.0029', activeIngredient: 'Fipronil 2,5%p/p', chemicalGroup: 'Fenil Pirazol', diluent: 'Água', reportLabel: 'principio_ativo', unit: 'un', minQuantity: 0, price: 0, isRegulated: true, isActive: true },
  { id: 'prod-optgard', orgId: ORG, name: 'Optgard', categoryId: 'cat-ins', registrationCode: '3.2398.0055.001-8', activeIngredient: 'Tiametoxam 1,0%', chemicalGroup: 'Neonicotinóide', diluent: 'Agua', reportLabel: 'principio_ativo', unit: 'un', minQuantity: 0, price: 0, isRegulated: true, isActive: true },
  { id: 'prod-attamix-po', orgId: ORG, name: 'Attamix Pó', categoryId: 'cat-cup', registrationCode: '3.2781.0091', activeIngredient: 'Fipronil, Alfacipemitrina, Propoxur', chemicalGroup: 'Fenil Pirazol / Piretróide / Metilcarbamato de Fenila', diluent: 'Água', treatment: 'Tratamento Sintomático', reportLabel: 'principio_ativo', unit: 'un', minQuantity: 0, price: 0, isRegulated: true, isActive: true },
  { id: 'prod-cipermitrina-40-pm', orgId: ORG, name: 'Cipermitrina 40 pm', categoryId: 'cat-ins', registrationCode: '3.2398.0045.002-1', activeIngredient: 'Cipermetrina 40% p/p', chemicalGroup: 'Piretróides', diluent: 'Agua', treatment: 'Sintomatico', reportLabel: 'principio_ativo', unit: 'un', minQuantity: 0, price: 0, isRegulated: true, isActive: true },
  { id: 'prod-bifentol-pro', orgId: ORG, name: 'Bifentol Pro', categoryId: 'cat-ins', registrationCode: '3.2398.0062.001-6', activeIngredient: 'Bifentrina, Imiprotrina e Permetrina', chemicalGroup: 'Piretróides', treatment: 'Sintomatico', reportLabel: 'principio_ativo', unit: 'un', minQuantity: 0, price: 0, isRegulated: true, isActive: true },
  { id: 'prod-aldeido-citronelal', orgId: ORG, name: 'Aldeído Citronelal', categoryId: 'cat-ins', registrationCode: '25351.406260/2019-54', activeIngredient: 'Cintronelal, Geraniol, Citronelol', chemicalGroup: 'Cintronelol', reportLabel: 'principio_ativo', unit: 'un', minQuantity: 0, price: 0, isRegulated: true, isActive: true },
  { id: 'prod-gel-repelente', orgId: ORG, name: 'Gel Repelente', categoryId: 'cat-ins', registrationCode: 'Insento', activeIngredient: 'Polímero de Isobuteno / Buteno 82% - Inertes 18%', chemicalGroup: 'Não Aplicável', reportLabel: 'principio_ativo', unit: 'un', minQuantity: 0, price: 0, isRegulated: true, isActive: true },
  { id: 'prod-oleo-de-mamona-etoxilado-spa', orgId: ORG, name: 'Óleo de Mamona Etoxilado/SPANT', categoryId: 'cat-ins', activeIngredient: 'Óleo de Mamona Etoxilado', chemicalGroup: 'Ricinus Communis L.', diluent: 'Pronto pra uso', treatment: 'Sintomatico', reportLabel: 'principio_ativo', unit: 'un', minQuantity: 0, price: 0, isRegulated: true, isActive: true },
  { id: 'prod-permetrina-ozz', orgId: ORG, name: 'Permetrina Ozz', categoryId: 'cat-ins', registrationCode: '3.0425.0104.001-5', activeIngredient: 'Permetrina', chemicalGroup: 'Peritróide', diluent: 'Pronto para Uso', reportLabel: 'principio_ativo', unit: 'un', minQuantity: 0, price: 0, isRegulated: true, isActive: true },
  { id: 'prod-twol', orgId: ORG, name: 'Twol', categoryId: 'cat-ins', registrationCode: '3.2398.0053.001-7', activeIngredient: 'Bifentrina e Diclovós', chemicalGroup: 'Organofosforado e Bifentrina', diluent: 'Água', reportLabel: 'principio_ativo', unit: 'un', minQuantity: 0, price: 0, isRegulated: true, isActive: true },
  { id: 'prod-pedra-sanitaria', orgId: ORG, name: 'Pedra Sanitaria', categoryId: 'cat-san', registrationCode: '323700010(Anvisa)', activeIngredient: 'Dodecibenzeno Sulfonato de Sódio, Sulfato de Sódio, Eucalyptus', chemicalGroup: 'paradiclorobenzeno', diluent: 'Pronto para Uso', reportLabel: 'principio_ativo', unit: 'un', minQuantity: 0, price: 0, isRegulated: true, isActive: true },
  { id: 'prod-bifentol', orgId: ORG, name: 'Bifentol', categoryId: 'cat-ins', registrationCode: '3.2398.0027.001-5', activeIngredient: 'Bifentrina 200 SC', chemicalGroup: 'Piretróide', diluent: 'Agua', treatment: 'Hipersensibilizante, distúrbios sensoriais cutâneos e neurite periférica', reportLabel: 'principio_ativo', unit: 'un', minQuantity: 0, price: 0, isRegulated: true, isActive: true },
  { id: 'prod-refil-adesivo-armadilha-mosc', orgId: ORG, name: 'Refil Adesivo - Armadilha MOSCA', categoryId: 'cat-epi', activeIngredient: 'sem química', chemicalGroup: 'sem química', diluent: 'Pronto pra uso', treatment: 'Sintomatico', reportLabel: 'principio_ativo', unit: 'un', minQuantity: 0, price: 0, isRegulated: true, isActive: true },
  { id: 'prod-ig-max-ce', orgId: ORG, name: 'IG MAX - CE', categoryId: 'cat-ins', registrationCode: '3.0425.0166', activeIngredient: 'Alfacipermitrina 5% - Piriproxifem 5%', chemicalGroup: 'Piretróides', diluent: 'Agua', treatment: 'Sintomatico', reportLabel: 'principio_ativo', unit: 'un', minQuantity: 0, price: 0, isRegulated: true, isActive: true },
  { id: 'prod-alfanol-50-sc', orgId: ORG, name: 'ALFANOL 50 SC', categoryId: 'cat-ins', registrationCode: '323980028001-0', activeIngredient: 'Alfacipermitrina 5%', chemicalGroup: 'Piretróide', diluent: 'Água', treatment: 'Sintomatico', reportLabel: 'principio_ativo', unit: 'un', minQuantity: 0, price: 0, isRegulated: true, isActive: true },
  { id: 'prod-scre4m', orgId: ORG, name: 'SCRE4M', categoryId: 'cat-cup', registrationCode: '3.2781.0085', activeIngredient: 'Bifentrina, Tiametoxam, Piriproxifem e Fipronil', chemicalGroup: ': PIRETRÓIDE, NEONICOTINÓIDE, ÉTER PIRIDILOXIPROPILICO e FENIL PIRAZOL.', treatment: 'Sintomatico', reportLabel: 'principio_ativo', unit: 'un', minQuantity: 0, price: 0, isRegulated: true, isActive: true },
  { id: 'prod-quantum', orgId: ORG, name: 'Quantum', categoryId: 'cat-ins', registrationCode: '3.3222.0054', activeIngredient: 'Imidacloprido 0,03 %p/p', chemicalGroup: 'Neonicotinoide', diluent: 'Pronto pra uso', treatment: 'Sintomatico', reportLabel: 'principio_ativo', unit: 'un', minQuantity: 0, price: 0, isRegulated: true, isActive: true },
  { id: 'prod-placa-de-cola-armadilha-ades', orgId: ORG, name: 'PLACA DE COLA - Armadilha Adesiva', categoryId: 'cat-epi', registrationCode: 'Produto isento de registro', activeIngredient: 'Armadilha Adesiva', chemicalGroup: 'Não tóxico', reportLabel: 'principio_ativo', unit: 'un', minQuantity: 0, price: 0, isRegulated: true, isActive: true },
  { id: 'prod-hipoclorito-de-sodio', orgId: ORG, name: 'Hipoclorito de sódio', categoryId: 'cat-san', registrationCode: '25351.472020/2019-48', activeIngredient: 'Cloro ativo', chemicalGroup: 'sais inorgânicos', diluent: 'Água', reportLabel: 'principio_ativo', unit: 'un', minQuantity: 0, price: 0, isRegulated: true, isActive: true },
  { id: 'prod-newtrine', orgId: ORG, name: 'Newtrine', categoryId: 'cat-ins', registrationCode: '3.2781.0089', activeIngredient: 'Lambda-Cialotrina, Propoxur e Piriproxifen.', chemicalGroup: 'Piretróides', diluent: 'Água', treatment: 'Sulfato de Atropina, e Oximas.', reportLabel: 'principio_ativo', unit: 'un', minQuantity: 0, price: 0, isRegulated: true, isActive: true },
  { id: 'prod-residuol-ps', orgId: ORG, name: 'Residuol Ps', categoryId: 'cat-ins', registrationCode: '3.2398.0054.001-2', activeIngredient: 'Bifentrina e Alfa-cipermitrina', chemicalGroup: 'Piretróide', diluent: 'Pronto pra uso', reportLabel: 'principio_ativo', unit: 'un', minQuantity: 0, price: 0, isRegulated: true, isActive: true },
  { id: 'prod-blatap-indoxacarbe', orgId: ORG, name: 'Blatap Indoxacarbe', categoryId: 'cat-ins', registrationCode: '334280026', activeIngredient: 'Indoxacarbe a 0,6%', chemicalGroup: 'Neonicotinóide', treatment: 'Sintomatico', reportLabel: 'principio_ativo', unit: 'un', minQuantity: 0, price: 0, isRegulated: true, isActive: true },
  { id: 'prod-fendona', orgId: ORG, name: 'Fendona', categoryId: 'cat-ins', registrationCode: '3.0404.0031.001-0', activeIngredient: 'Alfa-Cipermetrina 6%', chemicalGroup: 'Piretróide', diluent: 'Água', reportLabel: 'principio_ativo', unit: 'un', minQuantity: 0, price: 0, isRegulated: true, isActive: true },
  { id: 'prod-termiex', orgId: ORG, name: 'Termiex', categoryId: 'cat-cup', registrationCode: '3.1704.0068.001-0', activeIngredient: 'Fipronil 2,5%p/p', chemicalGroup: 'Fenil Pirazol', diluent: 'Água', reportLabel: 'principio_ativo', unit: 'un', minQuantity: 0, price: 0, isRegulated: true, isActive: true },
  { id: 'prod-atratol-mosca', orgId: ORG, name: 'ATRATOL MOSCA', categoryId: 'cat-ins', registrationCode: '3.2398.0044.002-5', activeIngredient: 'Imidacloprido a 0,5%p/p', chemicalGroup: 'Neonicotinóide', diluent: 'Pronto para Uso', reportLabel: 'principio_ativo', unit: 'un', minQuantity: 0, price: 0, isRegulated: true, isActive: true },
  { id: 'prod-pro-inset', orgId: ORG, name: 'Pro Inset', categoryId: 'cat-ins', registrationCode: '3.40670084', activeIngredient: 'Bifentrina 0,06', chemicalGroup: 'Piretróides e Piretrinas', reportLabel: 'principio_ativo', unit: 'un', minQuantity: 0, price: 0, isRegulated: true, isActive: true },
  { id: 'prod-madelesma-garden', orgId: ORG, name: 'Madelesma Garden', categoryId: 'cat-ins', registrationCode: '3.2057.0069', activeIngredient: 'Fosfato Férrico 3%', chemicalGroup: 'Inorgânico', diluent: 'Pronto para Uso', reportLabel: 'principio_ativo', unit: 'un', minQuantity: 0, price: 0, isRegulated: true, isActive: true },
  { id: 'prod-rigon-prime-extrusado', orgId: ORG, name: 'RIGON® PRIME EXTRUSADO', categoryId: 'cat-rod', registrationCode: '3.0425.0179.001-4', activeIngredient: 'Brodifacoum 0,005% (p/p', chemicalGroup: 'Cumarínico', diluent: 'Pronto para Uso', treatment: 'Vitamina K1 / Tratamento Sintomático', reportLabel: 'principio_ativo', unit: 'un', minQuantity: 0, price: 0, isRegulated: true, isActive: true },
  { id: 'prod-alcance', orgId: ORG, name: 'Alcance', categoryId: 'cat-ins', registrationCode: '3.2380.0014.001-1', activeIngredient: 'Tetrametrina/ D- Fenotrina', chemicalGroup: 'P i r e t r i n a s e P i r e t r ó i d e s', reportLabel: 'principio_ativo', unit: 'un', minQuantity: 0, price: 0, isRegulated: true, isActive: true },
];
...
export const appointments: Appointment[] = [
  ...
  { ...A('a-2', 'c-3', 'st-des', 'u-t1', 0, 10, 75, 'em_atendimento', 'alta', 2), fixedTime: true },
  { ...A('a-3', 'c-6', 'st-san', 'u-t1', 0, 14, 60, 'confirmado', 'normal', 3), fixedTime: true },
...
export const orgProfile = {
  ...
  street: 'Av. Engenheiro Luís Carlos Berrini, 1500',
  district: 'Brooklin',
  city: 'São Paulo',
  state: 'SP',
  cep: '04571-000',
  ...
  /** Responsável técnico — assina certificados e laudos. */
  technicalResponsibleName: 'Patrícia Nogueira',
  technicalResponsibleRole: 'Farmacêutica',
  technicalResponsibleRegistry: 'CRF-SP 48213',
};
